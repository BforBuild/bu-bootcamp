...
public class GradeAnalyzer {
    ...
    public static void main(String[] args) {
        ...
        if (scores.isEmpty()) {
            System.out.println("No valid scores found in scores.txt.");
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(filename))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                try {
                    ...
                    invalidLinesSkipped++;
                    System.out.println("Warning: skipping invalid score: " + trimmed);
                }
            }
        } catch (IOException e) {
    ...
    public static void writeReport(ArrayList<Integer> scores,
                                   ...
                                   String outputFile) {
        writeReport(scores, avg, high, low, outputFile, 0, 0, 0, 0, 0);
    }
    ...
    public static void writeReport(ArrayList<Integer> scores,
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(outputFile))) {
            ...
            System.out.println("Error writing report to file: " + outputFile);
        }
